...
pub enum RiscvReg {
    ...
    A2 = 12,  // x12 - Argument register
    A3 = 13,  // x13 - Argument register
    A4 = 14,  // x14 - Argument register
    A5 = 15,  // x15 - Argument register
    A6 = 16,  // x16 - Argument register
    A7 = 17,  // x17 - Argument register
